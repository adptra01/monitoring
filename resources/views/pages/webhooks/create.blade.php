...
$availableEvents = computed(function () {
    return ['license.created', 'license.suspended', 'license.revoked', 'license.restored', 'device.registered', 'device.deactivated', 'activation.approved', 'activation.rejected'];
});
        ...
        <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
            ...
            @if ($saved)
                <div
                    ...
                    <flux:heading size="lg" class="text-amber-800 dark:text-amber-200">{{ __('Webhook Secret') }}
                    </flux:heading>
                ...
                <div
                    ...
                    <form wire:submit="save" class="space-y-6">
                        ...
                        <div class="flex justify-end gap-2">
                            <flux:button href="{{ route('webhooks.index') }}" variant="filled">{{ __('Cancel') }}
                            </flux:button>
