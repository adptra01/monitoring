...
$updateMember = function (int $userId, string $role) {
...
<x-layouts::app :title="$this->permissions->canUpdateTeam ? __('Edit :name', ['name' => $teamData['name'] ?? $teamModel->name]) : __('View :name', ['name' => $teamData['name'] ?? $teamModel->name])">
    @volt
