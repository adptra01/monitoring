                            ...
                            <flux:table.row :key="$plan->id">
                                ...
                                <flux:table.cell>
                                    <div class="flex gap-2">
                                        <flux:button variant="ghost" size="sm" icon="pencil" href="{{ url('/admin/plans/' . $plan->id . '/edit') }}" />
                                        <flux:button variant="ghost" size="sm" icon="trash" wire:click="confirmDelete({{ $plan->id }})" />
                                    </div>
                                </flux:table.cell>
                            </flux:table.row>
                        @endforeach
